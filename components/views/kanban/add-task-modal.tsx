...
const initialState: AddTaskFormData = {
  title: '',
  description: '',
  estimatedHours: 0,
  estimatedMinutes: 0,
...
const [form, setForm] = React.useState<AddTaskFormData>(initialState);
const [errors, setErrors] = React.useState<Record<string, string>>({});
const [isSubmitting, setIsSubmitting] = React.useState(false);

React.useEffect(() => {
  setForm({ ...initialState, status: targetColumn });
}, [targetColumn, isOpen]);
